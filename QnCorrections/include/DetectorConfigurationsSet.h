...
class DetectorConfigurationsSet : public TObjArray {
 public:
  DetectorConfigurationsSet();
  virtual ~DetectorConfigurationsSet();
  ...
  virtual DetectorConfiguration *At(Int_t i) const { return (DetectorConfiguration *) TObjArray::At(i); }

/// \cond CLASSIMP
 ClassDef(DetectorConfigurationsSet, 1);
/// \endcond
};
}

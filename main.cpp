...
//  Qn::Internal::AddDetectorToFramework(manager, Qn::DetectorType::Track, vectordata, *eventset);
//  manager.SetShouldFillQAHistograms();
//  manager.SetShouldFillOutputHistograms();
//  int test[4];
//  manager.FindDetector(0)->FindDetectorConfiguration("0")->GetHarmonicMap(test);
...
//  }
//
//  std::cout << DetectorFactory::instance()->Test() << std::endl;

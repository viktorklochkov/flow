...
//  values[kNtracksSelected] = baseEvent->NTracks();
  ...
  const std::array<double, 4> zdcX = {{1.75, -1.75, 1.75, -1.75}};
  const std::array<double, 4> zdcY = {{-1.75, -1.75, 1.75, 1.75}};
  ...
  const Double_t kt0X[24] = {/* Cside */ 0.905348,0.571718,0.0848977,-0.424671,-0.82045,-0.99639,-0.905348,-0.571718,-0.0848977,0.424671,0.82045,0.99639,
      /* Aside */ 0.99995,0.870982,0.508635,0.00999978,-0.491315,-0.860982,-0.99995,-0.870982,-0.508635,-0.0100001,0.491315,0.860982};
  const Double_t kt0Y[24] = {/* Cside */ 0.424671,0.82045,0.99639,0.905348,0.571718,0.0848976,-0.424671,-0.82045,-0.99639,-0.905348,-0.571719,-0.0848975,
      /* Aside */ -0.00999983,0.491315,0.860982,0.99995,0.870982,0.508635,0.00999974,-0.491315,-0.860982,-0.99995,-0.870982,-0.508635};
  const Double_t t0phi[24] = {TMath::ATan2(kt0Y[0],kt0X[0]), TMath::ATan2(kt0Y[1],kt0X[1]), TMath::ATan2(kt0Y[2],kt0X[2]),
...
void AliReducedVarManager::FillITSlayerFlag(TRACK* track, Int_t layer, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillL0TriggerInputs(EVENT* event, Int_t input, double *values, Int_t input2 /*=999*/) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillL1TriggerInputs(EVENT* event, Int_t input, double *values, Int_t input2 /*=999*/) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillL2TriggerInputs(EVENT* event, Int_t input, double *values, Int_t input2 /*=999*/) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillEventTagInput(BASEEVENT* event, Int_t input, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillTPCclusterBitFlag(TRACK* track, Int_t bit, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillTrackingStatus(TRACK* p, double* values) {
  //
  // Fill tracking flags
  //
...
//_________________________________________________________________
/*void AliReducedVarManager::FillTrackingFlags(TRACK* p, double *values) {
  //
  // Fill tracking flags
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillTrackingFlag(TRACK* track, UInt_t flag, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillTrackQualityFlag(BASETRACK* track, UShort_t flag, double *values, UShort_t flag2 /*=999*/) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillTrackMCFlag(BASETRACK* track, UShort_t flag, double *values, UShort_t flag2 /*=999*/) {
   //
...
//_________________________________________________________________
void AliReducedVarManager::FillPairQualityFlag(PAIR* p, UShort_t flag, double *values, UShort_t flag2 /*=999*/) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillEventOnlineTriggers(AliReducedEventInfo* event, double *values){
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillEventOnlineTrigger(UShort_t triggerBit, double *values, UShort_t triggerBit2 /*=999*/) {
  //
  // fill the trigger bit input
...
//_________________________________________________________________
void AliReducedVarManager::FillMCTruthInfo(TRACK* p, double *values, TRACK* leg1 /* = 0x0 */, TRACK* leg2 /* = 0x0 */) {
   //
...
//_________________________________________________________________
void AliReducedVarManager::FillCaloClusterInfo(CLUSTER* cl, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillPairInfo(PAIR* p, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillPairInfo(BASETRACK* t1, BASETRACK* t2, Int_t type, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillPairInfoME(BASETRACK* t1, BASETRACK* t2, Int_t type, double *values) {
  //
...
//_________________________________________________________________
void AliReducedVarManager::FillPairInfo(PAIR* t1, BASETRACK* t2, Int_t type, double *values) {
  //
...
//__________________________________________________________________
void AliReducedVarManager::FillCorrelationInfo(BASETRACK* trig, BASETRACK* assoc, double *values) {
  //
...
//__________________________________________________________________
void AliReducedVarManager::FillCorrelationInfo(BASETRACK* t, double *values) {
  //
  // fill pair-track correlation information
  //
...
void AliReducedVarManager::GetThetaPhiCM(BASETRACK* leg1, BASETRACK* leg2,
				    ...
				    double leg1Mass /*=gkParticleMass[kElectron]*/, double leg2Mass /*=gkParticleMass[kElectron]*/)
{
  //

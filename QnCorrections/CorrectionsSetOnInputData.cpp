...
/// \cond CLASSIMP
ClassImp(Qn::CorrectionsSetOnInputData);
/// \endcond
namespace Qn {
/// Default constructor
CorrectionsSetOnInputData::CorrectionsSetOnInputData() : TList() {

}

/// Default destructor
CorrectionsSetOnInputData::~CorrectionsSetOnInputData() {
...
/// its key
void CorrectionsSetOnInputData::AddCorrection(CorrectionOnInputData *correction) {
  if (IsEmpty()) {
    AddFirst(correction);
  } else if (correction->Before((CorrectionOnInputData *) First())) {
    AddFirst(correction);
  } else if (((CorrectionOnInputData *) Last())->Before(correction)) {
    AddLast(correction);
  } else {
...
void CorrectionsSetOnInputData::FillOverallCorrectionsList(TList *correctionlist) const {
  if (!IsEmpty()) {

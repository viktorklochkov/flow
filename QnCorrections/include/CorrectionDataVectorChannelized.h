...
/// \date Jan 27, 2016
class CorrectionDataVectorChannelized : public CorrectionDataVector {
 public:

  CorrectionDataVectorChannelized();
  CorrectionDataVectorChannelized(Int_t channelId, Float_t phi, Float_t weight);
  virtual ~CorrectionDataVectorChannelized();
...
/// \cond CLASSIMP
 ClassDef(CorrectionDataVectorChannelized, 1);
/// \endcond
};
}

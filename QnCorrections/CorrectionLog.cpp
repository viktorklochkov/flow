...
// print the given message
  ...
  if (message!=NULL) {
    if (!(type < nLoggingLevel)) {
      switch (type) {
        case kInfo:Info(Form("I-%s", (const char *) sLocation), "%s", message);
          break;
        case kWarning:Warning(Form("W-%s", (const char *) sLocation), "%s", message);
          break;
        case kError:Error(Form("E-%s", (const char *) sLocation), "%s", message);
          break;
        case kFatal:Fatal(Form("FATAL-%s", (const char *) sLocation), "%s", message);
          break;
      }
    }
  } else {
    if (!(type < nLoggingLevel)) {
      switch (type) {
        case kInfo:Info(Form("I-%s", (const char *) sLocation), "%s", " ");
          break;
        case kWarning:Warning(Form("W-%s", (const char *) sLocation), "%s", " ");
          break;
        case kError:Error(Form("E-%s", (const char *) sLocation), "%s", " ");
          break;
        case kFatal:Fatal(Form("FATAL-%s", (const char *) sLocation), "%s", " ");
          break;
      }
    }
  }

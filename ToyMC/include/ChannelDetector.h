...
#ifndef FLOW_TOYMC_INCLUDE_CHANNELDETECTOR_H_
...
class ChannelDetector {
 public:
  ChannelDetector(const Qn::AxisD &axis, std::function<bool(double)> cuts) :
      n_channels_(axis.size()),
      axis_(axis),
...
#endif //FLOW_TOYMC_INCLUDE_CHANNELDETECTOR_H_

...
/// \cond CLASSIMP
ClassImp(Qn::CorrectionDataVectorChannelized);
/// \endcond
namespace Qn {

/// Default constructor
CorrectionDataVectorChannelized::CorrectionDataVectorChannelized() :
...
CorrectionDataVectorChannelized::CorrectionDataVectorChannelized(Int_t channelId, Float_t phi, Float_t weight) :

...
class AliReducedVarManager : public TObject {
 ...
 public:
  ...
  enum Variables {
    ...
    kVZEROChannelMult,
    kVZEROChannelRing = kVZEROChannelMult+64,// VZERO multiplicity per channel
    kVZEROChannelPhi = kVZEROChannelRing+64,
    kVZEROChannelEta = kVZEROChannelPhi+64,  // pseudo-rapidity of a VZERO channel
    ...
    kZDCPhi = kZDCnEnergyCh+10,
    kZDCpEnergyCh   = kZDCPhi+10,        // ZDCp energy in each channel
    // TZERO variables
    kTZEROAmplitudeCh = kZDCpEnergyCh+10,      // TZERO aplitudes in all channels
    kTZEROPhiCh       = kTZEROAmplitudeCh+26,
    kTZEROTOF         = kTZEROPhiCh+26,  // TZERO TOF start times
...
//  static void FillEventInfo(double *values);
  static void FillEventInfo(double* values);
  static void FillEventInfo(AliReducedBaseEvent* event, double* values, AliReducedEventPlaneInfo* eventPlane=0x0);
  static void FillEventOnlineTriggers(AliReducedEventInfo* event, double *values);
  static void FillEventOnlineTrigger(UShort_t triggerBit, double *values, UShort_t triggerBit2=999);
  static void FillEventTagInput(AliReducedBaseEvent* event, Int_t input, double *values);
  static void FillL0TriggerInputs(AliReducedEventInfo* event, Int_t input, double *values, Int_t input2=999);
  static void FillL1TriggerInputs(AliReducedEventInfo* event, Int_t input, double *values, Int_t input2=999);
  static void FillL2TriggerInputs(AliReducedEventInfo* event, Int_t input, double *values, Int_t input2=999);
  static void FillTrackingFlag(AliReducedTrackInfo* track, UInt_t flag, double *values);
  static void FillTrackQualityFlag(AliReducedBaseTrack* track, UShort_t flag, double *values, UShort_t flag2=999);
  static void FillTrackMCFlag(AliReducedBaseTrack* track, UShort_t flag, double *values, UShort_t flag2=999);
  static void FillPairQualityFlag(AliReducedPairInfo* p, UShort_t flag, double *values, UShort_t flag2=999);
  static void FillTrackInfo(AliReducedBaseTrack* p, double* values);
//  static void FillTrackInfo(AliReducedBaseTrack* p, double *values);
  static void FillITSlayerFlag(AliReducedTrackInfo* track, Int_t layer, double *values);
  static void FillTPCclusterBitFlag(AliReducedTrackInfo* track, Int_t bit, double *values);
  static void FillPairInfo(AliReducedPairInfo* p, double *values);
  static void FillPairInfo(AliReducedBaseTrack* t1, AliReducedBaseTrack* t2, Int_t type, double *values);
  static void FillPairInfo(AliReducedPairInfo* leg1, AliReducedBaseTrack* leg2, Int_t type, double *values);
  static void FillPairInfoME(AliReducedBaseTrack* t1, AliReducedBaseTrack* t2, Int_t type, double *values);
  static void FillCorrelationInfo(AliReducedBaseTrack* p, AliReducedBaseTrack* t, double *values);
  static void FillCorrelationInfo(AliReducedBaseTrack* t, double *values);
  static void FillCaloClusterInfo(AliReducedCaloClusterInfo* cl, double *values);
  static void FillTrackingStatus(AliReducedTrackInfo* p, double *values);
 // static void FillTrackingFlags(AliReducedTrackInfo* p, double *values);
  static void FillMCTruthInfo(AliReducedTrackInfo* p, double *values, AliReducedTrackInfo* leg1 = 0x0, AliReducedTrackInfo* leg2 = 0x0);
 ...
 private:
  ...
  static void GetThetaPhiCM(AliReducedBaseTrack* leg1, AliReducedBaseTrack* leg2,
                            double &thetaHE, double &phiHE,
			    double &thetaCS, double &phiCS,
			    double leg1Mass=fgkParticleMass[kElectron], double leg2Mass=fgkParticleMass[kElectron]);

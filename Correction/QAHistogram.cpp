...
QAHistogram::QAHistogram(std::string name, const AxisD &axis, std::string weight) :
    name_(std::move(name)),
...
QAHistogram::QAHistogram(std::string name, std::vector<AxisD> axes, std::string weight) :
    name_(std::move(name)),
    axes_(std::move(axes)),
    weight_(std::move(weight)),
    type_(Type::kTwoDim) {
...
QAHistogram::QAHistogram(std::string name, std::vector<AxisD> axes, std::string weight, const Qn::AxisD& histoaxis) :
    name_(std::move(name)),
    axes_(std::move(axes)),
    weight_(std::move(weight)),

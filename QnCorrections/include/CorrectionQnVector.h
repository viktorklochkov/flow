...
class CorrectionQnVector : public TNamed {
 public:
  ...
  void Set(CorrectionQnVector *Qn, Bool_t changename);
...
inline Int_t CorrectionQnVector::GetFirstHarmonic() const {
...
inline Int_t CorrectionQnVector::GetNextHarmonic(Int_t harmonic) const {
...
inline Float_t CorrectionQnVector::QxNorm(Int_t harmonic) const {
...
inline Float_t CorrectionQnVector::QyNorm(Int_t harmonic) const {
  if (Length(harmonic) < fMinimumSignificantValue) {
    return 0.0;
  } else {

...
#include "CorrectionHistogram.h"
#include "CorrectionLog.h"
/// \cond CLASSIMP
ClassImp(Qn::CorrectionHistogram);
/// \endcond
namespace Qn {

/// Default constructor
CorrectionHistogram::CorrectionHistogram() :
...
CorrectionHistogram::CorrectionHistogram(const char *name,
                                               const char *title,
...
Bool_t CorrectionHistogram::CreateHistogram(TList *histogramList) {
...
Long64_t CorrectionHistogram::GetBin(const double *variableContainer) {
...
Bool_t CorrectionHistogram::BinContentValidated(Long64_t) {
...
Float_t CorrectionHistogram::GetBinContent(Long64_t bin) {
...
Float_t CorrectionHistogram::GetBinError(Long64_t bin) {
...
void CorrectionHistogram::Fill(const double *variableContainer, Float_t weight) {
